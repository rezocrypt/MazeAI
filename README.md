...
- [Website](https://rezocrypt.github.io/MazeAI/)
- [Github Repo](https://rezocrypt.github.io/MazeAI/)
...
New Maze - Generates new random maze.
Reset Maze - Clears all steps done by the player and starts from the same clear maze.
Step - It does exactly one step suggested by neural network.
Try - Tries to solve the full maze (can take up to few seconds).
Learn - It was made for learning but it doesn't work yet.
